            ...
            <td width="145px" style="padding-left:20px">
                <nav>
                    <div style="width:150px">
                        ...
                        <a href="joinclass" sid="11" class="list-group-item moduleItemLeft"> <span>加入班级</span> </a>
                    </div>
                </nav>
            </td>
            <td width="280px">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h1 class="text-center text-primary">加入班级</h1>
                            </div>
                            <div class="modal-body">
                                <form class="form col-md-12 center-block" id="loginForm" action="joinClasssAction"
                                      method="post">
                                    <div class="form-group-lg" id="accountDiv">
                                        <label class="sr-only" for="inputAccount">邀请码</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
                                            </div>
                                            <input class="form-control" id="inputAccount" name="invitation" type="text"
                                                   placeholder="邀请码" required autofocus>
                                        </div>
                                        <div class="hidden text-center" id="accountMsg">
                                            <span class="glyphicon glyphicon-exclamation-sign"></span>邀请码不存在
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-md-1"></div>
                                        <button class="btn btn-primary btn-lg col-md-4" id="btn_create" type="sumbit">
                                            加入
                                        </button>
                                        <div class="col-md-2"></div>
                                        <button class="btn btn-primary btn-lg col-md-4" id="btn_reset" type="reset">重填
                                        </button>
                                        <div class="col-md-1"></div>
                                    </div>
                                </form>
