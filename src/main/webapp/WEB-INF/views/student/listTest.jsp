            ...
            <td width="60px" style="padding-left:20px">
                <nav>
                    <div style="width:150px">
                        ...
                        <a href="listTestAction?classsId=${sessionScope.classs.id}" sid="11" class="list-group-item moduleItemLeft"> <span>查看测试</span> </a>
                        <a href="listStudent?classsId=${sessionScope.classs.id}" sid="39" class="list-group-item moduleItemLeft"> <span>查看同学</span> </a>
                    </div>
                </nav>
            </td>
                    ...
                    <div class="panel-body">
                        ...
                        <c:forEach items="${tests}" var="test" varStatus="st">
                            <a href="listSubjectAction?testId=${test.id}" class="module" class="module">
                                ...
                                <br/>
                                <br/>
                                <c:if test="${test.grade == null}">
                                    <span style="color: red">还未开始做题，请尽快</span>
                                </c:if>
                                <c:if test="${test.grade !=null}">
                                    <span>已做完，成绩为：${test.grade.grade}</span>
                                </c:if>
