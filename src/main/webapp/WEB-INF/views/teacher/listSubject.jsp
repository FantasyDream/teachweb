    ...
    <nav class="navbar navbar-inverse" role="navigation">
        ...
        <div>
            <ul class="nav navbar-nav">
                <li><a href="teacher/listClass" style="color: white">首页</a></li>
            </ul>
            ...
            <td width="60px" style="padding-left:20px">
                <nav>
                    <div style="width:150px">
                        ...
                        <a href="listStudentGrade?testId=${test.id}" sid="11" class="list-group-item moduleItemLeft"> <span>查看学生成绩</span> </a>
                ...
                <div id="s12" class="panel panel-default moduleItemRight">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${subjects}" var="Subjects" varStatus="st">
                                <tr>
                                    <td>${st.count}</td>
                                    <td>${Subjects.expression}</td>
                                    <td>=</td>
