                ...
                <form class="form col-md-12 center-block" id="loginForm" action="login" method="post">
                    <div class="form-group-lg" id="accountDiv">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" id="inputAccount" name="phone" type="text" placeholder="手机号" required autofocus>
                        </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-primary btn-lg col-md-6" id="btn_login" type="sumbit">登录</button>
